...
- **Запити зацікавлених осіб** – вимоги, очікування та потреби різних категорій користувачів системи, що визначають її функціональні та нефункціональні характеристики.
- **Замовник** – організація або особа, що ініціює розробку системи, визначає її бізнес-цілі та забезпечує фінансування проєкту.
- **Користувач опитувань** – особа, яка проходить опитування або переглядає його результати.
